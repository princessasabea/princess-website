...
const Wireframes: React.FC = () => {
  ...
  const appScreens = [
    ...
    { title: "Order History", description: "Transparent log of all past and current orders.", img: "https://raw.githubusercontent.com/princessasabea/myKartghwebsite/main/public/order-history-screen.png" },
