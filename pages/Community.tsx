...
const InteractiveStory: React.FC<{ 
  ...
  return (
    <div className="w-full bg-white rounded-2xl md:rounded-[3rem] border border-gray-100 shadow-2xl overflow-hidden mb-8 md:mb-16">
      <div className="p-5 md:p-12 border-b border-gray-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h3 className="text-xl md:text-3xl font-black text-dark tracking-tighter leading-tight">{title}</h3>
          <p className="text-xs md:text-base text-muted font-medium">{subtitle}</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="flex-1 p-5 md:p-12 flex flex-col justify-center bg-gradient-to-br from-white to-gray-50 min-h-[240px] md:min-h-[450px]">
          <div className="flex items-center gap-3 mb-4 md:mb-6">
            ...
            <span className="text-[10px] md:text-xs font-black text-muted uppercase tracking-[0.2em]">Step {currentStep + 1} of {steps.length}</span>
          </div>
          <h4 className="text-lg md:text-3xl font-black text-dark mb-3 md:mb-4 leading-tight">{steps[currentStep].title}</h4>
          <p className="text-sm md:text-lg text-muted font-medium leading-relaxed mb-6 md:mb-8">
        ...
        <div className="flex-1 relative overflow-hidden h-[200px] md:h-auto min-h-[200px]">
          ...
          <div className="absolute inset-0 bg-dark/20 backdrop-blur-[1px] flex items-center justify-center">
             <div className="w-12 h-12 md:w-24 md:h-24 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/30 text-white animate-pulse">
...
const Community: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full bg-bg-light">
      ...
      <section className="py-10 md:py-24 px-4 bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
           <h2 className="text-xl md:text-5xl font-black mb-4 md:mb-8 tracking-tighter text-dark">More Than Just Groceries.</h2>
           <p className="text-sm md:text-xl text-muted leading-relaxed font-medium mb-6 md:mb-12">
      ...
      <section className="py-10 md:py-24 px-4 bg-bg-light pt-0">
        <div className="max-w-6xl mx-auto">
          <div className="mb-6 md:mb-16">
            ...
            <h2 className="text-2xl md:text-6xl font-black text-dark tracking-tighter mb-2 md:mb-4">Kommunity Hub <span className="text-[10px] md:text-sm font-bold bg-dark text-white px-2 md:px-3 py-1 rounded-full align-middle ml-1 md:ml-2 uppercase tracking-widest">MVP</span></h2>
            <p className="text-sm md:text-xl text-muted font-medium max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
             {feedItems.map((item, idx) => (
                <div key={idx} className="bg-white rounded-2xl md:rounded-[3rem] overflow-hidden border border-gray-100 shadow-xl shadow-gray-200/50 hover:border-primary/20 transition-all flex flex-col">
                   <div className="p-4 md:p-8 border-b border-gray-50 flex items-center justify-between">
                      <div className="flex items-center gap-2 md:gap-4">
                         ...
                         <div>
                            <h4 className="font-black text-dark leading-none mb-1 text-xs md:text-base">{item.author}</h4>
                            <p className="text-[8px] md:text-[10px] font-bold text-muted uppercase tracking-widest">{item.location} • {item.time}</p>
                         </div>
                      </div>
                   ...
                   <div className="p-4 md:p-8 flex-1">
                      <p className="text-muted font-medium text-sm md:text-lg leading-relaxed mb-4 md:mb-6">
                         "{item.content}"
                      </p>
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <div className="p-3 md:p-6 bg-cream rounded-xl md:rounded-2xl text-center">
                ...
                <p className="text-[8px] md:text-xs font-bold text-muted uppercase tracking-tighter">Target Partners</p>
              </div>
              <div className="p-3 md:p-6 bg-cream rounded-xl md:rounded-2xl text-center">
                <p className="text-xl md:text-3xl font-black text-primary mb-1">Planned</p>
                <p className="text-[8px] md:text-xs font-bold text-muted uppercase tracking-tighter">Fair Trade Policy</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-10 md:py-24 bg-bg-light px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="flex-1 order-1 md:order-2">
             ...
             <p className="text-muted text-sm md:text-lg leading-relaxed mb-6 md:mb-8">
